	...
	return (
		<nav className="nav">
            <ul>
                ...
                <li><Link className="nav__link prices"  onClick={()=>{currentPage(); pageTop();}} onMouseOver={hover} to="/prices/">Цены</Link></li>
                <li><Link className="nav__link contacts"  onClick={()=>{currentPage(); pageTop();}} onMouseOver={hover} to="/contacts/">Контакты</Link></li>
            </ul>
        </nav>
	);
}
